...
export const getStorefront = async () => await request
  .get(`${apiBase}/v2/store`)
  .set(apiHeaders)
  .then((res): object => res)
  .catch(err => console.error(err));

export const getProductImages = async (productID = {}) => await request
...
export const getCustomFields = async (data = {}) => await request
